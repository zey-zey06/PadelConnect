...
export default function ClubSetup() {
  ...
  // Already has a club → go straight to dashboard
  useEffect(() => {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Backend issued a new JWT with organization_id — refresh user context
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-lg space-y-8">
        ...
        <form
          ...
          className="rounded-2xl border border-border bg-card shadow-sm p-8 space-y-5"
        >
          {error && (
          ...
          <div className="space-y-1.5">
            ...
            <Input
              id="c-name"
              placeholder="ex: Padel Club Abidjan"
              value={form.name}
              onChange={set('name')}
              autoFocus
            />
