  ...
  await knex('player_profiles').insert([
    {
      ...
      bio:          'Joueur régulier niveau intermédiaire, disponible le weekend et certains soirs. Je cherche des partenaires motivés !',
      is_available: true,
      created_at:   now,
      updated_at:   now,
    },
    {
      ...
      bio:          'Joueuse occasionnelle, débutante, préfère jouer entre femmes ou en mixte sympa.',
      is_available: true,
      created_at:   now,
      updated_at:   now,
    },
    ...
    },
    {
      ...
      bio:          'Joueuse intermédiaire, cherche sessions mixtes ou féminines conviviales.',
      is_available: true,
      created_at:   now,
      updated_at:   now,
    },
    {
      ...
      bio:          'Joueur avancé, compétitif. Tôt le matin ou tard le soir. Niveau minimum 4 svp.',
      is_available: true,
      created_at:   now,
      updated_at:   now,
    },
